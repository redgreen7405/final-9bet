        ...
        <div className="container mx-auto px-4 py-6 pb-24">
          <div className="bg-white rounded-lg shadow-md p-6">
            ...
            <p className="text-justify">
              This Privacy Policy describes how https://9bets.pages.dev/ general
              store and its affiliates (collectively &quot; general store , we,
              our, us&quot;) collect, use, share, protect or otherwise process
            ...
            <p className="text-justify">
              ...
              person/association claiming to be general store seeking any
              personal data like debit/credit card PIN, net-banking or mobile
            ...
            <h2 className="text-2xl font-semibold mt-4 mb-2">Usage</h2>
            <p className="text-justify">
              ...
              time of collection of information. You understand that your access
              to these products/services may be affected in the event permission
              is not provided to us.
            </p>

            <h2 className="text-2xl font-semibold mt-4 mb-2">Sharing</h2>
            <p className="text-justify">
              ...
              comply with our legal obligations, to enforce our user agreement,
              to facilitate our marketing and advertising activities, to
              ...
              sensitive personal data to government agencies or other authorised
              law enforcement agencies if required to do so by law or in the
            ...
            <p className="text-justify">
              ...
              practices. We may alert/notify you about significant changes to
